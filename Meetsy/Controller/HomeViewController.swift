...
class HomeViewController: UIViewController{
    ...
    @IBOutlet weak var viewYourProfile: UIButton!
    ...
    @IBAction func signout(_ sender: Any) {
        ...
        UDM.shared.setLoggedInStatus(status: false)
        UDM.shared.resetKey(key: "name")
        UDM.shared.resetKey(key: "noOfLinks")
        UDM.shared.resetKey(key: "userId")
//
    ...
    override func viewDidLoad() {
        ...
        //linkUpButton.applyGradient(colours: [UIColor.yellow , UIColor.blue])
       ...
       // numberOfLinks.text = String("\(UDM.shared.getNoLinks()) Links")
        ...
        viewYourProfile.layer.borderColor = UIColor(red: 0.53, green: 0.53, blue: 0.53, alpha: 1.00).cgColor
        viewYourProfile.layer.borderWidth = 1
        viewYourProfile.layer.cornerRadius = viewYourProfile.frame.height / 2
...
extension HomeViewController: UICollectionViewDataSource{
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if(indexPath.row == lastindex - 1 ){
            ...
            cell2.mainView.backgroundColor = UIColor.white
            cell2.mainView.layer.borderColor = UIColor(red: 0.53, green: 0.53, blue: 0.53, alpha: 1.00).cgColor
        ...
        if (socialsDataSource != nil && socialsDataSource.count > 0){
            ...
            cell.mainView.layer.cornerRadius = 10
                //cell.mainView.layer.borderColor =
            cell.mainView.backgroundColor = UIColor.white
            cell.mainView.layer.borderColor = UIColor(red: 0.53, green: 0.53, blue: 0.53, alpha: 1.00).cgColor
